export function DescSection() {
  return (
    <div className="bg-white px-6 py-10 lg:px-8 relative z-[1000]">
      <div className="mx-auto max-w-4xl text-base leading-7 text-gray-700">
        <p className="text-base font-semibold leading-7 text-indigo-600"></p>
        <h2 className="mt-6 text-2xl font-bold tracking-tight text-gray-900">Introducing</h2>
        <h3 className="mt-6 font-semibold text-gray-900">What is Replaceanything Framework?</h3>
        <p className="mt-3">
        ...
        <h3 className="mt-6 font-semibold text-gray-900">What are its Uses?</h3>
        <p className="mt-3">
        ...
        <div className="mt-16">
          <h2 className="text-2xl font-bold tracking-tight text-gray-900">How to Use Modelscope Replaceanything</h2>
          <p className="mt-6">
